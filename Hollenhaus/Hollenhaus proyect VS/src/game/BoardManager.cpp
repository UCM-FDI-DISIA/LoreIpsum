...
void BoardManager::initComponent()
{
	...
	p1Text->addComponent<TextComponent>("", "8bit", SDL_Color({ 255, 255, 255, 255 }), 50, TextComponent::BoxPivotPoint::CenterCenter, TextComponent::TextAlignment::Center);
	p2Text->addComponent<TextComponent>("", "8bit", SDL_Color({ 255, 255, 255, 255 }), 50, TextComponent::BoxPivotPoint::CenterCenter, TextComponent::TextAlignment::Center);
...
{
	return cardsOnBoard == size * size; // recordad que os mataré
}
