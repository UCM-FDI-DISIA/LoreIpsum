...
void MultiplayerPreGameState::onEnter()
{
	...
	setMazeButton->addComponent<TextComponent>("SET MAZE", Fonts::GROTESK_32, SDL_Color({ 0, 0, 0 ,0 }), 200, Text::BoxPivotPoint::CenterCenter, Text::TextAlignment::Center);
	...
	TextComponent* tc = readyButton->addComponent<TextComponent>("READY", Fonts::GROTESK_32, SDL_Color({ 255, 0, 0 ,0 }), 150, Text::BoxPivotPoint::CenterCenter, Text::TextAlignment::Center);
	...
	pregameEntity->addComponent<TextComponent>("OponentNotReady", Fonts::GROTESK_16, SDL_Color({ 0, 0, 0 ,0 }), 200, Text::BoxPivotPoint::CenterCenter, Text::TextAlignment::Center);
