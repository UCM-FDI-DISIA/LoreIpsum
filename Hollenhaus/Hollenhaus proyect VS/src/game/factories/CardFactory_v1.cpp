...
void CardFactory_v1::addValueCostTexts(ecs::entity_t card, int value, int cost)
{
	...
	textoValor->addComponent<TextComponent>(std::to_string(value), "8bit_24pt", SDL_Color({ 255, 255, 255, 255 }), 100, Text::CenterCenter, Text::Center);
	...
	textoCoste->addComponent<TextComponent>(std::to_string(cost), "8bit_24pt", SDL_Color({ 255, 255, 255, 255 }), 100, Text::CenterCenter, Text::Center);
