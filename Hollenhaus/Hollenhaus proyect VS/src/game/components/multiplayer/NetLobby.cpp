...
void NetLobby::InstantiateInvitationPanel()
{
	...
	acceptButton->addComponent<TextComponent>("ACEPTAR INVITACI�N", Fonts::GROTESK_32, Colors::VERDE_BENEFICIO, 200, Text::BoxPivotPoint::CenterCenter, Text::TextAlignment::Center);
	...
	declineButton->addComponent<TextComponent>("RECHAZAR INVITACI�N", Fonts::GROTESK_32, Colors::ROJO_PERJUICIO, 200, Text::BoxPivotPoint::CenterCenter, Text::TextAlignment::Center);
