...
public:
	...
	static Uint16 getSocketPort(TCPsocket sock)
	{
	...
	static Uint8* serialize_all(Uint8* buf, Ts&... args)
	{
	...
	template <typename... Ts>
	static Uint8* deserialize_all(Uint8* buf, Ts&... args)
	{
	...
	static Uint8* serialize(T (&v)[N], Uint8* buf)
	{
		return serialize_array(v, N, buf);
	}

	template <typename T, std::size_t N>
	static Uint8* deserialize(T (&v)[N], Uint8* buf)
	{
	...
	// ASCII codes
	template <>
	static Uint8* serialize<char>(char& v, Uint8* buf)
	{
	...
	template <>
	static Uint8* deserialize<char>(char& v, Uint8* buf)
	{
		Uint8& aux_v = reinterpret_cast<Uint8&>(v);
	...
	// case for Uint8
	template <>
	static Uint8* serialize<Uint8>(Uint8& v, Uint8* buf)
	{
		return serialize_uint(v, buf);
	}

	template <>
	static Uint8* deserialize<Uint8>(Uint8& v, Uint8* buf)
	{
	...
	// case for Uint16
	template <>
	static Uint8* serialize<Uint16>(Uint16& v, Uint8* buf)
	{
		return serialize_uint(v, buf);
	}

	template <>
	static Uint8* deserialize<Uint16>(Uint16& v, Uint8* buf)
	{
		return deserialize_uint(v, buf);
	}
	...
	// case for Uint32
	template <>
	static Uint8* serialize<Uint32>(Uint32& v, Uint8* buf)
	{
		return serialize_uint(v, buf);
	}

	template <>
	static Uint8* deserialize<Uint32>(Uint32& v, Uint8* buf)
	{
		return deserialize_uint(v, buf);
	}
	...
	// case for Sint8
	template <>
	static Uint8* serialize<Sint8>(Sint8& v, Uint8* buf)
	{
		return serialize_sint<Uint8>(v, buf);
	}

	template <>
	static Uint8* deserialize<Sint8>(Sint8& v, Uint8* buf)
	{
	...
	// case for Sint16
	template <>
	static Uint8* serialize<Sint16>(Sint16& v, Uint8* buf)
	{
		return serialize_sint<Uint16>(v, buf);
	}

	template <>
	static Uint8* deserialize<Sint16>(Sint16& v, Uint8* buf)
	{
	...
	// case for Sint32
	template <>
	static Uint8* serialize<Sint32>(Sint32& v, Uint8* buf)
	{
		return serialize_sint<Uint32>(v, buf);
	}

	template <>
	static Uint8* deserialize<Sint32>(Sint32& v, Uint8* buf)
	{
	...
	//
	template <>
	static Uint8* serialize<float>(float& v, Uint8* buf)
	{
	...
	template <>
	static Uint8* deserialize<float>(float& v, Uint8* buf)
	{
		static_assert(sizeof(float) == 4, "float is not 32 bits");
	...
	template <>
	static Uint8* serialize_array<char>(char* v, std::size_t N,
	                                    Uint8* buf)
	{
	...
	template <>
	static Uint8* deserialize_array<char>(char* v, std::size_t N,
	                                      Uint8* buf)
	{
	...
	template <>
	static Uint8* serialize_array<Uint8>(Uint8* v, std::size_t N,
	                                     Uint8* buf)
	{
	...
	template <>
	static Uint8* deserialize_array<Uint8>(Uint8* v, std::size_t N,
	                                       Uint8* buf)
	{
	...
	//
	static Uint8* receiveMsg(TCPsocket sock)
	{
		int result = 0;
