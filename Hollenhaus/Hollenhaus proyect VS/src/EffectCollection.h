...
public:
	...
	void addValueAdj(Cell* cardCell, Direction direction, int add, bool ultimateArrow);

	// añade valor a la propia carta si esta en centro - si el número de cartas a izq/der/arr/abj son el mismo
	void addValueCenter(int add, Cell* cardCell);
	...
	void blockCard(Direction direction);	
